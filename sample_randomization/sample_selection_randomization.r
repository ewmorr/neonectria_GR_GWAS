...
sample_df = read.table("data/sequenced_samples_for_growth_rate_randomization_NF_03212022.txt", header = T)
...
write.table(sample.random_selection, file = "data/sequenced_samples_random_select_NF_03222022.txt", sep = "\t", quote = F, row.names = F)
